...
namespace Restaurant_Data.Migrations
{
    ...
    [Migration("20210408131800_DatabaseRelations5")]
    partial class DatabaseRelations5
    {
            ...
            modelBuilder.Entity("Restaurant_Core.Order", b =>
                {
                    ...
                    b.HasOne("Restaurant_Core.Table", null)
                        .WithOne("Order")
                        .HasForeignKey("Restaurant_Core.Order", "TableId")
